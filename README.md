...
### 📖LLM Inference Applications ([©️back👆🏻](#paperlist))
<div id="LLM-Inference-Applications"></div>

|Date|Title|App|Code|Recom|
|:---:|:---:|:---:|:---:|:---:|
|2024.01|[**StoryRoute**] StoryRoute: Real-time LLM inference-powered travel storytelling web app — generates immersive, personalized travel narratives via live LLM inference calls(@samirk08)|[[app]](https://storyroute.netlify.app)|[[storyroute]](https://github.com/samirk08/storyroute) ![](https://img.shields.io/github/stars/samirk08/storyroute.svg?style=social)|⭐️ |
